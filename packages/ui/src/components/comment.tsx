...
import { Avatar, AvatarFallback, AvatarImage } from '@sker/components/ui/avatar';
import { Button } from '@sker/components/ui/button';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuGroup,
  DropdownMenuItem,
  DropdownMenuTrigger,
} from '@sker/components/ui/dropdown-menu';
import { cn } from '@sker/ui/lib/utils';
import { BasicMarksKit } from '@sker/ui/components/basic-marks-kit';
import {
  type TDiscussion,
  discussionPlugin,
} from '@sker/ui/components/discussion-kit';
