...
/**
 * Handle data parts streamed by the chat transport:
 * - `data-toolName`  -> store the active AI tool on the editor.
 * - `data-comment`   -> turn the AI comment into a discussion and comment marks.
 */
export const handleChatData = (
  editor: PlateEditor,
  data: DataUIPart<MessageDataPart>
) => {
