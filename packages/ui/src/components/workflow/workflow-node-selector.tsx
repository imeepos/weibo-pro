...
export const WorkflowNodeSelector: React.FC<WorkflowNodeSelectorProps> = ({
  ...
  const selectorContent = (
    <div
      className={cn(
        'workflow-node-selector min-w-[18rem] max-w-lg rounded-xl border border-[#3b4354]',
        'bg-[#111318] shadow-2xl shadow-black/40 backdrop-blur-xl',
        className
      )}
      style={{
        position: 'fixed',
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-xs text-[#6c7a91]">{node.type}</span>
                  </div>
                </div>
