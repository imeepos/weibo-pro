 ...
 * - 避免重复处理导致统计数据重复累加
 *
 * Mock EntityManager 抽取到 src/test/helpers/weibo-ajax-statuses-show-mock-entity-manager.ts。
 * 边界情况与 error_code=20170 见 WeiboAjaxStatusesShowAstVisitor.edge.test.ts。
 */
