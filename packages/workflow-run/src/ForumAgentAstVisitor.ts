...
@Injectable()
export class ForumAgentAstVisitor {

    @Handler(ForumAgentAst)
    visit(ast: ForumAgentAst, input$: Observable<Record<string, unknown>>, _ctx: WorkflowGraphAst): Observable<NodeEvent> {
        return new Observable<NodeEvent>((obs) => {
            ...
            const subscription = input$.pipe(
                ...
                ErrorHandlerOperators.createRetryOperator(ast, { logPrefix: '[ForumAgentAstVisitor]' }),
                ErrorHandlerOperators.createCatchErrorOperator(ast, { logPrefix: '[ForumAgentAstVisitor]' }),
