...
@Injectable()
export class LlmTextToVideoAstVisitor {
    @Handler(LlmTextToVideoAst)
    visit(ast: LlmTextToVideoAst, input$: Observable<Record<string, unknown>>) {
        return new Observable<NodeEvent>(obs => {
            ...
            const subscription = input$.pipe(
                ...
                ErrorHandlerOperators.createRetryOperator(ast, { logPrefix: '[LlmTextToVideoAstVisitor]' }),
                ErrorHandlerOperators.createCatchErrorOperator(ast, { logPrefix: '[LlmTextToVideoAstVisitor]' }),
