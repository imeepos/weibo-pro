...
@Injectable()
export class InsightAgentAstVisitor {

    @Handler(InsightAgentAst)
    visit(ast: InsightAgentAst, input$: Observable<Record<string, unknown>>, _ctx: WorkflowGraphAst): Observable<NodeEvent> {
        return new Observable<NodeEvent>((obs) => {
            ...
            const subscription = input$.pipe(
                ...
                ErrorHandlerOperators.createRetryOperator(ast, { logPrefix: '[InsightAgentAstVisitor]' }),
                ErrorHandlerOperators.createCatchErrorOperator(ast, { logPrefix: '[InsightAgentAstVisitor]' }),
