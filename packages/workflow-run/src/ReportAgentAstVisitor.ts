...
@Injectable()
export class ReportAgentAstVisitor {

    @Handler(ReportAgentAst)
    visit(ast: ReportAgentAst, input$: Observable<Record<string, unknown>>, _ctx: WorkflowGraphAst): Observable<NodeEvent> {
        return new Observable<NodeEvent>((obs) => {
            ...
            const subscription = input$.pipe(
                ...
                ErrorHandlerOperators.createRetryOperator(ast, { logPrefix: '[ReportAgentAstVisitor]' }),
                ErrorHandlerOperators.createCatchErrorOperator(ast, { logPrefix: '[ReportAgentAstVisitor]' }),
